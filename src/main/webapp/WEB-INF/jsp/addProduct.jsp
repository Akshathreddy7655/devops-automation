...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://localhost:8080/products/addProduct">Add Product</a></li>
...
<div class="container-fluid" style="margin: 20px">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <form:form method="post"   enctype="multipart/form-data" action="/products/saveProduct" modelAttribute="product">
                    ...
                    <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" path="description" placeholder="description"></form:input>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="text-align: center;">
                        <button class="btn btn-success"   value="Add" type="Product">Add Product</button>
                    </div>
