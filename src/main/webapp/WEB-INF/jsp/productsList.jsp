...
<div class="container">
    <div class="row">
        ...
        <c:forEach items="${productsList}" var="value">

            <div onclick="window.location.href='http://localhost:8080/products/viewProduct/${value.id}'" class="col-sm-3 .bg-success.bg-gradient"  id="${value} ">
